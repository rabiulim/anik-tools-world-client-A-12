...
const Tool = ({ tool }) => {
    const { id, name, img, price, minimumOrder, availableQuantity, description } = tool;
        ...
        <div class="card w-84 bg-base-100 shadow-xl">
            ...
            <div class="card-body items-center text-center">
                ...
                <div class="card-actions">
                    <button class="btn btn-sm btn-primary w-full" onClick={() => navigateBuyPage(id)}>Buy Now</button>
                </div>
            </div>
        </div>
    );
